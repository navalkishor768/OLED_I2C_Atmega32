...
#else
#error "No valid displaymode! Refer i2c_oled_SSD1306.h"
#endif
...
void lcd_command(uint8_t cmd[], uint8_t size) {
	i2c_start1((LCD_I2C_ADR << 1) |0);		// I2C Write Mode Send Device Address
