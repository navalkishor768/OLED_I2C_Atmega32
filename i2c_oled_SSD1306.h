...
#define I2C			// I2C(currently supported) or SPI (not supported yet)	
...
#ifdef I2C
#include "i2cnaval.h"	// library for I2C-communication
...
void i2c_start1(uint8_t i2c_addr);
